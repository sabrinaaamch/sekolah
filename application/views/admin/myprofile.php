                            ...
                            <div class="well well-sm">
                                <div class="row">
                                    <?php foreach ($profile as $p) : ?>
                                        <div class="col-md-3">
                                            <?php if ($p->image == null) { ?>
                                                <img src="<?= base_url('assets/dist/img/user-default.png') ?>" alt="" class="img-rounded img-responsive" />
                                            <?php } else { ?>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <hr>
                                            <p>
                                                <span id="bio">Biografi : <?php if ($p->bio == null) {
                                                                                echo '-';
                                                                            } else {
                                                                                echo $p->bio;
                                                                            } ?></span>
                                            ...
                                            <hr>
                                            <p>
                                                <span>No. WhatsApp : <?php if (isset($p->no_telp)) {
                                                                            echo '0' . $p->no_telp;
                                                                        } else {
                                                                        } ?></span>
                                            </p>

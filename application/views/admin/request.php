                        ...
                        <tbody>
                            ...
                            <?php foreach ($peminjaman as $q) : ?>
                                <tr>
                                    ...
                                    <td><?php echo longdate_indo($q->tanggal); ?></td>
                                    <td><?php echo $q->keterangan; ?></td>
                                    <td>
                                        <a href="<?php echo base_url('admin/accrequest/' . $q->id_peminjaman) ?>" onclick="return confirm('Terima Request?')" class="btn btn-sm btn-primary"><i class="fa fa-check"></i></a>
                                        <a href="<?php echo base_url('admin/disaccrequest/' . $q->id_peminjaman) ?>" onclick="return confirm('Tolak Request?')" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>

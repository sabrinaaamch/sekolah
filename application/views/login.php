...
<body class="hold-transition login-page" style="background: url('<?php echo base_url('assets/') ?>dist/img/bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; ">
        ...
        <form action="<?php echo base_url('auth') ?>" method="post" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="col-12 text-center">
              <button type="submit" name="masuk" class="btn btn-primary btn-block btn-flat rounded">Masuk</button>
              <hr>
              <p class="font-weight-bold">Belum Punya akun?
                <br>
                <sub class="font-weight-normal text-info">Silahkan hubungi Guru untuk pembuatan akun!</sub>
              </p>
            </div>
            <!-- /.col -->
          </div>

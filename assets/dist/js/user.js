...
document.getElementById("imageRuang").addEventListener("change", function () {
  var preview = document.getElementById("imagePreview");
  var file = this.files[0];
  var reader = new FileReader();

  reader.onloadend = function () {
    preview.innerHTML = '<img src="' + reader.result + '" width="100" class="mt-2" alt="Preview">';
  }

  if (file) {
    reader.readAsDataURL(file);
  } else {
    preview.innerHTML = ""; // Jika tidak ada gambar yang dipilih, hapus preview.
  }
});
